export default {
  ...
  personal: {
    ...
    status: '当前状态',
    statusPlaceholder: '例如：在读-随时到岗',
    expectedLocation: '期望工作地',
    expectedLocationPlaceholder: '请输入期望工作地',
    expectedSalary: '期望薪资',
    expectedSalaryPlaceholder: '请输入期望薪资',
    email: '邮箱',
    ...
    github: 'GitHub',
    githubPlaceholder: '请输入 GitHub 主页',
    location: '所在地',
